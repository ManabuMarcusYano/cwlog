...
module GoodbyeChatwork
  class Client
    ...
    def old_chat room_id, first_chat_id = 0
      ...
      res = @client.get "https://kcw.kddi.ne.jp/gateway.php?cmd=load_old_chat&myid=#{@myid}&_v=1.80a&_av=4&_t=#{@token}&ln=ja&room_id=#{room_id}&last_chat_id=0&first_chat_id=#{first_chat_id}&jump_to_chat_id=0&unread_num=0&file=1&desc=1"
      self.wait
    ...
    def file_info(file_id)
      ...
      r = @client.get "https://kcw.kddi.ne.jp/gateway.php?cmd=download_file&bin=1&file_id=#{file_id}"
      self.wait
